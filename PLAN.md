...
- [ ] Phase 1 — Repo scaffold: .gitignore, backend/frontend skeletons, deps pinned
- [ ] Phase 2 — Core substrate: db.py (SQLCipher + migrations), vault.py, config.py; tests
- [ ] Phase 3 — Auth: users, sessions, login/unlock endpoints, failed-login alerting; tests
